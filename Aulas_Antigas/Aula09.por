programa{
	...
	funcao inicio(){
		...
		escolha(pais){
			...
			pare
			caso 2: escreva("Neerlandês, Papíamento e Língua Frísia")
			pare
			...
			pare	
			caso 8: escreva("Africâner, Inglês, ndebele, xhosa, zulu, soto do norte, soto do sul, tswana, suázi, venda, tsonga")
			pare
